...
def get_cookie_image_url(cookie_name: str) -> str:
    ...
    cookie_image_map = {
        ...
        "Financier Cookie": "https://static.wikia.nocookie.net/cookierunkingdom/images/9/95/Financierhead.png",
        ...
        "Pancake Cookie": "https://static.wikia.nocookie.net/cookierunkingdom/images/1/1f/Pancake_head.webp",
